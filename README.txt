...
step 4:
    ...
    b: feature selection                                            -- input datasets['train_pool','selected_features'], output datasets['train_ready','selected_features'], to_csv('train_ready.csv','selected_features.csv')
step 5:
